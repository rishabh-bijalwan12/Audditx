...
const Landingpage = () => {
  return (
    <>
    <div className='w-screen    h-fit  lg:h-screen  grid bg-gradient-to-b  gap-4  lg:bg-gradient-to-r from-green1 to-green2 '>
        ...
        <div className='font-letter  grid gap-3 lg:gap-1 '>
            <div>
                ...
                <ul className='list-disc'>
                 ...
                 <div className='w-full h-full   grid z-50    justify-items-center items-center'>
                    <div className=' grid  m-5r'>
                    <div className='font-letter '>Our app is still in development</div>
                    <div className='font-letter w-11/12'>Due to high traffic we are only accepting businesses on either invite only or by que basics  </div>
                    <div className='font-letter m-2 ' >Provide us Your Email or Phone(or both),So we can Contact With you   </div>
                    </div>
                    <form className='w-full grid ustify-items-center shadow-2xl lg:rounded-2xl bg-stone-100 p-5'>

                    <div className='w-full justify-items-center text-start  grid'> 

                    <div className='text-start font-letter'>Enter Invite Code</div>
                      <input
                                    type="text"
                                    className="
                                    form-control
